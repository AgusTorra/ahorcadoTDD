...
public class AhorcadoUnitTest {
    ...
    public void jugadorAnonimoTest() {
        ...
        //Assert
        assertEquals("anónimo", ahorcado.getJugador().getNombre());
    }
    ...
    public void seleccionarModoDeJuegoTest() {
        ...
        Ahorcado ahorcado = new Ahorcado();
        //act
        ahorcado.seleccionarModo("Estándar");
        //assert
        assertEquals("Estándar", ahorcado.getModoJuego());
    }
    ...
    public void seleccionarDificultadTest() {
        ...
        Ahorcado ahorcado = new Ahorcado();
        //act
        ahorcado.seleccionarDificultad("Fácil");
        //assert
        assertEquals("Fácil", ahorcado.getDificultadPal());
    }
    ...
    public void seleccionarTematicaTest() {
        ...
        Ahorcado ahorcado = new Ahorcado();
        //act
        ahorcado.seleccionarTemática("Animales");
        //assert
        assertEquals("Animales", ahorcado.getTemáticaPal());
    }
    ...
    public void seleccionarTiempoLimiteTest() {
        ...
        Ahorcado ahorcado = new Ahorcado();
        //act
        ahorcado.seleccionarTiempoLímite(60); // segundos
        //assert
        assertEquals(60, ahorcado.getTiempoLímite());
    }
    ...
    public void verificarDificultadPalabraTest() {
        ...
        ahorcado.comenzarJuego();
        //assert
        assertEquals("Fácil", ahorcado.getPalabra().getDificultad());
    }

    @Test
    //Verificamos que la temática de la palabra obtenida para jugar
    //corresponda con la temática seleccionada en opciones
    public void verificarTematicaPalabraTest() {
        ...
        ahorcado.comenzarJuego();
        //assert
        assertEquals("Animales", ahorcado.getPalabra().getTemática());
    }
